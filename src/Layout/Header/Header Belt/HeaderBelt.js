    ...
    return (
        <AppBar position="sticky" elevation={0} >
            <Toolbar disableGutters>
                ...
                <Stack direction={'row'} paddingTop={1} pl={1}>
                    <SearchBar />

                    <StyledTooltip title={<LanguageTTC />} arrow >
                        <Button sx={{ padding: "10px", ...buttonStyle }}
                            variant='contained'
                    ...
                    {/* ================ */}
                    <Button variant='contained' color='primary' sx={{ ...buttonStyle }} onClick={handleReturnAndOrderClick}>
                        <Box sx={{
                            textAlign: "left",
                        }}>
                            <Typography variant='body2' component={'div'} sx={
